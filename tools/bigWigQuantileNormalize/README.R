...
lines(Y ~ X, json3, type="l", col="coral4")
legend("topright", legend=c("ATAC Forebrain day 11.5 (reference)", "ATAC Forebrain day 13.5", "ATAC Forebrain day 13.5 (normalized)"), col=c("black", "darkolivegreen4", "coral4"), lty=c(1,1,2), bty="n")
dev.off()
