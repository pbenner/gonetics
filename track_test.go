...
func TestTrack7(t *testing.T) {
  ...
  if err := track.ExportBigWig("track_test.1.bw.tmp"); err != nil {
    t.Error(err)
  }
...
func TestTrack8(t *testing.T) {
  ...
  if err := track1.ExportBigWig("track_test.3.bw.tmp"); err != nil {
    t.Error(err)
  }
